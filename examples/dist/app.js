...
_reactDom2['default'].render(_react2['default'].createElement(
  ...
  _react2['default'].createElement(
    ...
    _react2['default'].createElement(_componentsMinimalReactText2['default'], { label: 'Label', maxRows: 10, rows: 1 }),
    _react2['default'].createElement(
      'h3',
      null,
      'Large Textarea'
